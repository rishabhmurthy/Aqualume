...
/**
 * Implementation of the WaterQualityRepository interface
 */
class WaterQualityRepositoryImpl : WaterQualityRepository {
    ...
    /**
     * Get the first station with recent results (less than 1 year old) within the specified radius
     * If no recent results are found within the specified radius, returns the station
    ...
    override suspend fun getFirstStationWithRecentResults(
        ...
        return withContext(Dispatchers.IO) {
            safeApiCall {
                ...
                // If no results found within radius, try remaining stations
     ...
     * This implementation handles quoted fields and escaped quotes
     */
